...
- **NO crear archivos `.json`**. Esa funcionalidad quedó obsoleta.
- **NO omitir información**. Toda la información y contexto dado por el usuario debe ser utilizado en la generación final. No existe la limitación de texto.
- **Triple Verificación Inquebrantable**: Nunca se debe presentar una ficha sin haberla pasado por los tres filtros de calidad de la Fase 10.
- **Formato Estricto de 2 Párrafos**: En el bloque de "Estilo de respuesta" y en los Training Examples se impone de forma rígida un formato donde el párrafo 1 son acciones (entre paréntesis) y el párrafo 2 es el diálogo puro.
- **Respeto a las Directrices del Usuario**: Si el personaje requiere un tono adulto, coqueto o que se salga del estándar por pedido del usuario, se debe respetar íntegramente.
